...
- [ ] Authentication extras: No host-key verification, agent forwarding, public-key auth, keyboard-interactive, or cert support yet—linux ssh/PuTTY cover all of these.
