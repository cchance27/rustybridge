...
#[component]
pub fn BrowserIcon() -> Element {
    rsx! {
        svg {
            id: "master-artboard",
            view_box: "0 0 980 980",
            version: "1.1",
            ...
            rect {
                ...
                width: "784.007",
                height: "508.88",
                style: "fill: rgb(255,255,255); stroke: rgb(255,255,255); stroke-width: 0px;"
            },
            ...
            g {
                transform: "matrix(5.745971202850343, 0, 0, 5.745971202850343, -239.0126714986872, -174.32509063270783)",
                g { id: "g-1",
                    g { id: "g-2",
                        path {
                            d: "M 62.303428649902344 84.90811920166016 L 96.586669921875 104.67881774902344",
            ...
            g {
                transform: "matrix(5.745971202850343, 0, 0, 5.745971202850343, 4.790534412112947, -215.4151278944586)",
                g { id: "g-3",
                    g { id: "g-4",
                        path {
                            d: "M 62.303428649902344 84.90811920166016 L 96.586669921875 104.67881774902344",
            ...
            g {
                transform: "matrix(6.350236892700194, 0, 0, 6.350236892700194, -3326.7524824142347, -1.1867956834561255)",
                g { id: "g-5",
                    g { id: "g-6" }
                }
            },
